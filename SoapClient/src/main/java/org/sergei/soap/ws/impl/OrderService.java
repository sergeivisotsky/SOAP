 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://impl.ws.soap.sergei.org/", wsdlLocation = "http://localhost:8079/soap/ws/v1/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://impl.ws.soap.sergei.org/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8079/soap/ws/v1/OrderService?wsdl");
     ...
     *     returns Order
     */
    @WebEndpoint(name = "Order")
    public Order getOrder() {
        return super.getPort(new QName("http://impl.ws.soap.sergei.org/", "Order"), Order.class);
    }
     ...
     */
    @WebEndpoint(name = "Order")
    public Order getOrder(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.ws.soap.sergei.org/", "Order"), Order.class, features);
    }
